...
def _eval(s: str, variables: set[Variable]) -> object:
    from deesi.firstorder import Ex, All, Equivalent, Implies, And, Or, Not, T, F  # noqa
...
def _map_option(deesi_setting: bool, redlog_switch: str) -> str:
    return f'{"on" if deesi_setting else "off"} {redlog_switch};'
